...
public class CommonDate {
	...
	/**
	 * 获得 yyyy-MM-dd HH:mm:ss 格式的当前时间字符串
	 * 
	 * @return String
	 */
	...
	public static String fDateCNYRS(Date date) {
		return toString(date, "yyyy年MM月dd日 HH点");
	}
	...
	public static String fDateCNYRSF(Date date) {
		return toString(date, "yyyy年MM月dd日 HH:mm");
	}
	...
	public static String fDateCNYRSFM(Date date) {
		return toString(date, "yyyy年MM月dd日 HH:mm:ss");
	}
